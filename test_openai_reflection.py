"""
Simplified test for the multi-turn reflection capability using OpenAI directly.
This bypasses the circular import issues by not importing journal_service.
"""
...
def test_initial_prompt():
    ...
    prompt = f"""
    You are Mira, a warm, compassionate CBT journaling coach. 
    ...
    3. Offer practical, actionable steps 
    ...
    1. INSIGHT TEXT: Initial empathy with precise emotion labeling + gentle reframe
    2. REFLECTION PROMPT: A single, focused question that explores relationship context or emotional needs
    3. FOLLOW-UP TEXT: Support and mini reframe with practical action steps
    ...
    {{
        ...
        "reflection_prompt": "Take a moment. What's one expectation you've been holding about this relationship that feels heavy?",
...
def test_second_followup(second_reflection):
    ...
    prompt = f"""
    You are Mira, a CBT-informed journaling guide. The user has shared deeper insights after your previous prompts about perfectionism and anxiety.
...
def main():
    ...
    logger.info("Starting OpenAI reflection testing...")
